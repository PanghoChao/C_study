...
int main_pointer(void)
{
	...
	*/
	...
	int arr[3] = { 5,10,15 };
	int* ptr = arr; // ptr 과 arr은 똑같은 것이 된다.
	for (int i = 0; i < 3; i++)
	{
	...
	printf("arr의 자체의 값이 가지는 주소의 실제 값 : %d\n", *arr); //*(arr+0)
